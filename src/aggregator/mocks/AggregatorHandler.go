...
// Disable2FA provides a mock function with given fields: w, r
func (_m *AggregatorHandler) Disable2FA(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}

// Enable2FA provides a mock function with given fields: w, r
func (_m *AggregatorHandler) Enable2FA(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}

// Enabled2FA provides a mock function with given fields: w, r
func (_m *AggregatorHandler) Enabled2FA(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}

// GenerateOTPSecret provides a mock function with given fields: w, r
func (_m *AggregatorHandler) GenerateOTPSecret(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}
...
// LoginOTP provides a mock function with given fields: w, r
func (_m *AggregatorHandler) LoginOTP(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}
...
// UpdatePassword2FA provides a mock function with given fields: w, r
func (_m *AggregatorHandler) UpdatePassword2FA(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}
...
// ValidateOTP provides a mock function with given fields: w, r
func (_m *AggregatorHandler) ValidateOTP(w http.ResponseWriter, r *http.Request) {
	_m.Called(w, r)
}
