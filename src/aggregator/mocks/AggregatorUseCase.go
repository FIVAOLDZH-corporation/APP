...
func (_m *AggregatorUseCase) Disable2FA(ctx context.Context, email string) error {
...
func (_m *AggregatorUseCase) Enable2FA(ctx context.Context, email string) error {
	ret := _m.Called(ctx, email)
...
func (_m *AggregatorUseCase) Enabled2FA(ctx context.Context, email string) (bool, error) {
	ret := _m.Called(ctx, email)
...
func (_m *AggregatorUseCase) GenerateOTPSecret(ctx context.Context, email string) (string, error) {
	ret := _m.Called(ctx, email)
...
func (_m *AggregatorUseCase) LoginOTP(ctx context.Context, email string, otp string) (*dto.Tokens, error) {
...
func (_m *AggregatorUseCase) UpdatePassword2FA(ctx context.Context, email string, oldPassword string, newPassword string, otp string) error {
...
func (_m *AggregatorUseCase) ValidateOTP(ctx context.Context, email string, otp string) (bool, error) {
	ret := _m.Called(ctx, email, otp)
