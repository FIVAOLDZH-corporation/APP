...
func (_m *UserRepository) GetNewUsers(ctx context.Context, from time.Time, to time.Time) ([]entity.User, error) {
...
func (_m *UserRepository) GetUserByID(ctx context.Context, id uuid.UUID) (*entity.User, error) {
	ret := _m.Called(ctx, id)
...
func (_m *UserRepository) GetUsers(ctx context.Context, filter repository.UserFilter) ([]entity.User, error) {
...
func (_m *UserRepository) GetUsersBatch(ctx context.Context, limit int, offset int) ([]entity.User, error) {
